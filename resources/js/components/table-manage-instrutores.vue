        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in instrutores" :key="index">
                            <td>{{ item.id_funcionario }}</td>
                            <td>{{ item.nome }}</td>
                            <td>{{ item.cpf }}</td>
                            <td>{{ item.rg }}</td>
                            <td>{{ item.tipoAula["0"].nome }}</td>
                   ...
                   <!--  <td>
                        ...
                        >
                            ...
                            <input
                                ...
                                v-bind:value="token"
                            />
                            <a v-bind:href="detalhe">Detalhes</a>
                            |
...
<script>
export default {
    props: ["titulo", "titulos",  "instrutores", "token"],

    mounted() {
        console.log("componente de gerenciamento de clientes.");
    }
};
</script>
